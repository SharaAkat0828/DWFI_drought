...
project_stocking_rate <- function(realization, output_dir, reg_model) {
  ...
  yearly_drought_data_projected_4.5$total_D <-  -yearly_drought_data_projected_4.5$total_D 
  yearly_drought_data_projected_8.5$total_D <-  -yearly_drought_data_projected_8.5$total_D 
